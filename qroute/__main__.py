...
if __name__ == '__main__':
    ...
    if args.dataset == "sample":
        circuits_1 = ['miller_11_onlyCX.qasm', 'rd32-v0_66_onlyCX.qasm',
                      'decod24-bdd_294_onlyCX.qasm', 'alu-v0_26_onlyCX.qasm']
        circuits_2 = ['miller_11_onlyCX.qasm', 'qft_10_onlyCX.qasm', '4_49_16_onlyCX.qasm', 'rd53_138_onlyCX.qasm',
                      'sys6-v0_111_onlyCX.qasm', 'mini_alu_305_onlyCX.qasm', 'cnt3-5_179_onlyCX.qasm',
                      'decod24-bdd_294_onlyCX.qasm', 'alu-v0_26_onlyCX.qasm']
        for e, file in enumerate(circuits_1 + circuits_2):
